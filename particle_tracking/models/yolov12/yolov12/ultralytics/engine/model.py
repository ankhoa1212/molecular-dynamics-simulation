...
class Model(
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt") -> None:
        ...
        updates = {
            "model": (
                deepcopy(self.model).half() if isinstance(self.model, nn.Module) else self.model
            ),
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        overrides = (
            yaml_load(checks.check_yaml(kwargs["cfg"])) if kwargs.get("cfg") else self.overrides
        )
        custom = {
