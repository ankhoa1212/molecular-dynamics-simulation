...
class SAM2TwoWayTransformer(TwoWayTransformer):
    ...
    def __init__(
        ...
        """
        super().__init__(
            depth, embedding_dim, num_heads, mlp_dim, activation, attention_downsample_rate
        )
...
class RoPEAttention(Attention):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.rope_k_repeat = (
            rope_k_repeat  # repeat q rope to match k length, needed for cross-attention to memories
        )
